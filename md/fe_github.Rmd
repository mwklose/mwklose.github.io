...
To use Git, we need to have Git installed first.

You have a couple of options to download Git:

## Manual Download
To manually download Git, you can navigate to the [Git Download Site](https://git-scm.com) to download the latest version of Git. Then go install Homebrew or Chocolatey, because they are super useful and necessary. 
